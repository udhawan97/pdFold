...
/// persists via `@AppStorage` so the choice survives relaunch.
struct LanguageSwitcher: View {
    ...
    var body: some View {
        ...
        .fixedSize()
        .help(String(localized: "languageSwitcher.help", defaultValue: "Choose the app language"))
        .accessibilityLabel(String(localized: "languageSwitcher.accessibilityLabel", defaultValue: "App language"))
    }
}
