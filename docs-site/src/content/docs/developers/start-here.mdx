...
Orifold is a native macOS PDF workspace: Swift 5.9+, 100% SwiftUI, four local PDF engines plus a signing pipeline, <Stat name="tests" /> tests, zero network calls. This page orients you before you open the tree.
