...
<Callout variant="warning">
	Two things you can't combine yet: **object editing and inline text editing on the same document**. If a document already has text edits, the Select tool will ask you to finish or undo them first (and vice versa) — this keeps either kind of edit from overwriting the other. **Rotated pages** are also not editable yet; the object stays selectable but can't be moved.
</Callout>
